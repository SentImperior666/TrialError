...
hook_alive event (close checks it ...)." Design Section 12 (M6 row): "hook
command lines invoke `python` explicitly (Windows)" — see
``plugin/hooks/hooks.json``.

Claude Code invokes this script for every ``SessionStart`` event (session
