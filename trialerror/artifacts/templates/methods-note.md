---
artifact_id: MN-000            # registry-assigned, immutable
...
type: methods-note             # fixed for this template
version: v1                    # bumped on revision; superseded versions kept
stage: in-progress             # planning|in-progress|results|reflection|keystone
threads: [T?]                  # program threads touched
hypotheses: []                 # every hypothesis touched (may be empty for pure conventions)
...
## The technique / convention
<!-- What it is and what it is for. Bar: IR_SPEC, dice-tape conventions. -->

## Exact rules
<!-- NORMATIVE. Numbered rules a consuming agent can enforce mechanically; no examples-in-place-of-rules. -->

## Known limits
<!-- Where the technique breaks or does not apply. -->

## Version + dependents
<!-- Current version and everything that depends on it; breaking-change discipline per the gold↔IR contract — a rule change here obligates a sweep of dependents. -->
...
`{"type":"artifact_registered","ts":"<ISO-8601>","agent":"<agent-id>","artifact_id":"MN-000","artifact_type":"methods-note","title":"<title>","purpose":"<self-contained research rationale, C-0014 standard>","threads":["T?"],"gate":"ungated","supersedes":null,"path":"research/artifacts/MN-000_<slug>.md","corrections_pin":"v<N>@<YYYY-MM-DD>","attempt":1,"step":"S?"}`
<!-- Projector output (canonical registry-line format, owned by the ARTIFACTS.md header):
`- MN-000 | methods-note | <title> | T? | gate: ungated | supersedes: - | research/artifacts/MN-000_<slug>.md` -->
