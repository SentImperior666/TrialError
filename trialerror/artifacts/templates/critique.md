---
artifact_id: CR-000            # registry-assigned, immutable
...
type: critique                 # fixed for this template
...
hypotheses: []                 # every hypothesis touched
depends_on: [XX-000]           # at minimum, the target artifact
...
## Target artifact
<!-- Artifact id + version under review. Bar: every gate review from the pre-study. -->

## Item-by-item findings
<!-- Per claim/section: BROKEN | FRAGILE | CONFIRMED, each with evidence — no unevidenced labels.
Gate checklist also applies: frontmatter complete; verdict-first header present; depends_on accurate (spot-walk the DAG one level); registry event emitted and folded ([SPEC-PASS] outbox/projector, not a direct registry write). -->

## Spot-check record
<!-- What was actually re-run / re-fetched / recounted, with results. A critique that re-ran nothing says so explicitly. -->

## Verdict + required edits
<!-- ship | edits | rework, and if edits: the required edits ENUMERATED so the author can close them one by one. -->
...
`{"type":"artifact_registered","ts":"<ISO-8601>","agent":"<agent-id>","artifact_id":"CR-000","artifact_type":"critique","title":"<title>","purpose":"<self-contained research rationale, C-0014 standard>","threads":["T?"],"gate":"ungated","supersedes":null,"path":"research/artifacts/CR-000_<slug>.md","corrections_pin":"v<N>@<YYYY-MM-DD>","attempt":1,"step":"S?"}`
<!-- Projector output (canonical registry-line format, owned by the ARTIFACTS.md header):
`- CR-000 | critique | <title> | T? | gate: ungated | supersedes: - | research/artifacts/CR-000_<slug>.md` -->
