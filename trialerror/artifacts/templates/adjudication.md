---
artifact_id: AJ-000            # registry-assigned, immutable; [SPEC-PASS] AD→AJ: canonical prefix per research_artifacts.md §2
...
type: adjudication             # fixed for this template
...
hypotheses: [H???]             # the hypothesis(es) being adjudicated
depends_on: []                 # the evidence artifacts (probe-reports, critiques, ...)
...
## Hypothesis id
<!-- The exact ledger hypothesis id(s) this record moves. -->

## Old → new status
<!-- One line per hypothesis: prior status → new status. -->

## Evidence artifacts
<!-- The artifact ids that justify the move; mirror in depends_on. No move without a registered artifact behind it. -->

## Ledger-safe wording
<!-- The EXACT text to paste into the hypothesis ledger. Iter-3 discipline: never worded stronger than the gate allows. -->

## Registry event
<!-- [SPEC-PASS] AD→AJ fixed (canonical prefix per research_artifacts.md §2). Outbox/projector
...
`{"type":"artifact_registered","ts":"<ISO-8601>","agent":"<agent-id>","artifact_id":"AJ-000","artifact_type":"adjudication","title":"<title>","purpose":"<self-contained research rationale, C-0014 standard>","threads":["T?"],"gate":"ungated","supersedes":null,"path":"research/artifacts/AJ-000_<slug>.md","corrections_pin":"v<N>@<YYYY-MM-DD>","attempt":1,"step":"S?"}`
<!-- Projector output (canonical registry-line format, owned by the ARTIFACTS.md header):
`- AJ-000 | adjudication | <title> | T? | gate: ungated | supersedes: - | research/artifacts/AJ-000_<slug>.md` -->
